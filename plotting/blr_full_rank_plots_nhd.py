...
ss = 100
# # full rank problem
string ='nhd_results/full/result_blr_full_rank_problem'
...
plt.yticks(fontsize=18)
plt.tight_layout()
fig_name = 'blr_fr_traces_nhd.pdf'
plt.savefig(fig_name)
plt.show()
...
plt.yticks(fontsize=18)
plt.tight_layout()
fig_name = 'blr_fr_is_traces_nhd.pdf'
plt.savefig(fig_name)
plt.show()
